...
################################################################
# This is a generated script based on design: Conways_system
#
...
# source Conways_system_script.tcl
...
set design_name Conways_system
...
proc create_root_design { parentCell } {
  ...
  set Top_0 [ create_bd_cell -type ip -vlnv LAFAYETTE:user:Top:1.0 Top_0 ]
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins Conways_write_6reg_0/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net Conways_write_6reg_0_control_signal [get_bd_pins Conways_write_6reg_0/control_signal] [get_bd_pins Top_0/control_signal]
  connect_bd_net -net Conways_write_6reg_0_rowcoor [get_bd_pins Conways_write_6reg_0/rowcoor] [get_bd_pins Top_0/rowcoor]
  connect_bd_net -net Conways_write_6reg_0_write_single_pe [get_bd_pins Conways_write_6reg_0/write_single_pe] [get_bd_pins Top_0/single_write]
  ...
  connect_bd_net -net Top_0_blue [get_bd_ports blue] [get_bd_pins Top_0/blue]
  connect_bd_net -net Top_0_green [get_bd_ports green] [get_bd_pins Top_0/green]
  connect_bd_net -net Top_0_output_row_1 [get_bd_pins Conways_write_6reg_0/input_row_1] [get_bd_pins Top_0/output_row_1]
  connect_bd_net -net Top_0_output_row_2 [get_bd_pins Conways_write_6reg_0/input_row_2] [get_bd_pins Top_0/output_row_2]
  connect_bd_net -net Top_0_red [get_bd_ports red] [get_bd_pins Top_0/red]
  connect_bd_net -net Top_0_running_cycles [get_bd_pins Conways_write_6reg_0/output_cycles] [get_bd_pins Top_0/running_cycles]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins Top_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Conways_write_6reg_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins Conways_write_6reg_0/s00_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]
  connect_bd_net -net sw_1 [get_bd_ports sw] [get_bd_pins Top_0/sw]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Conways_write_6reg_0/S00_AXI/S00_AXI_reg] SEG_Conways_write_6reg_0_S00_AXI_reg
...
preplace port Vsync -pg 1 -y 260 -defaultsOSRD
preplace port sw -pg 1 -lvl 4:-100 -defaultsOSRD -top
preplace port Hsync -pg 1 -y 240 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 380 -defaultsOSRD
preplace port clk -pg 1 -lvl 4:-120 -defaultsOSRD -top
preplace port reset -pg 1 -y 310 -defaultsOSRD
preplace portBus blue -pg 1 -y 220 -defaultsOSRD
preplace portBus green -pg 1 -y 200 -defaultsOSRD
preplace portBus red -pg 1 -y 180 -defaultsOSRD
preplace inst rst_processing_system7_0_100M -pg 1 -lvl 1 -y 220 -defaultsOSRD
preplace inst Top_0 -pg 1 -lvl 4 -y 230 -defaultsOSRD
preplace inst Conways_write_6reg_0 -pg 1 -lvl 3 -y 240 -defaultsOSRD
preplace inst processing_system7_0_axi_periph -pg 1 -lvl 2 -y 190 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -y 440 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 1 4 NJ 360 NJ 360 NJ 360 NJ
preplace netloc Top_0_Vsync 1 4 1 NJ
preplace netloc Top_0_blue 1 4 1 NJ
preplace netloc processing_system7_0_axi_periph_M00_AXI 1 2 1 N
preplace netloc Conways_write_6reg_0_write_single_pe 1 3 1 1110
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 440
preplace netloc Conways_write_6reg_0_control_signal 1 3 1 1100
preplace netloc Top_0_green 1 4 1 NJ
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 130 410
preplace netloc Top_0_running_cycles 1 2 3 780 110 NJ 110 1460
preplace netloc Top_0_Hsync 1 4 1 NJ
preplace netloc Top_0_red 1 4 1 NJ
preplace netloc Conways_write_6reg_0_rowcoor 1 3 1 1090
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 1 2 460 310 NJ
preplace netloc clk_1 1 3 1 1100
preplace netloc processing_system7_0_FIXED_IO 1 1 4 NJ 380 NJ 380 NJ 380 NJ
preplace netloc Top_0_output_row_1 1 2 3 760 80 NJ 80 1480
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 1 1 450
preplace netloc sw_1 1 3 1 1110
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 120 430 320 NJ
preplace netloc Top_0_output_row_2 1 2 3 770 90 NJ 90 1470
preplace netloc reset_1 1 0 4 NJ 310 NJ 340 NJ 340 NJ
levelinfo -pg 1 0 220 610 940 1310 1510 -top -10 -bot 570
",
}

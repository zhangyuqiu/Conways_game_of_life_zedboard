...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins Conways_write_4reg_0/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net Conways_write_4reg_0_control_signal [get_bd_pins Conways_write_4reg_0/control_signal] [get_bd_pins Top_0/control_signal]
  connect_bd_net -net Conways_write_4reg_0_rowcoor [get_bd_pins Conways_write_4reg_0/rowcoor] [get_bd_pins Top_0/rowcoor]
  connect_bd_net -net Conways_write_4reg_0_write_single_pe [get_bd_pins Conways_write_4reg_0/write_single_pe] [get_bd_pins Top_0/single_write]
  ...
  connect_bd_net -net Top_0_output_row [get_bd_pins Conways_write_4reg_0/input_row] [get_bd_pins Top_0/output_row]
  connect_bd_net -net Top_0_red [get_bd_ports red] [get_bd_pins Top_0/red]
  connect_bd_net -net Top_0_running_cycles [get_bd_pins Conways_write_4reg_0/output_cycles] [get_bd_pins Top_0/running_cycles]
  connect_bd_net -net clk_1 [get_bd_ports clk] [get_bd_pins Top_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Conways_write_4reg_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins Conways_write_4reg_0/s00_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]
  connect_bd_net -net sw_1 [get_bd_ports sw] [get_bd_pins Top_0/sw]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Conways_write_4reg_0/S00_AXI/S00_AXI_reg] SEG_Conways_write_4reg_0_S00_AXI_reg
...
preplace port reset -pg 1 -y 270 -defaultsOSRD
preplace portBus blue -pg 1 -y 200 -defaultsOSRD
preplace portBus green -pg 1 -y 180 -defaultsOSRD
preplace portBus red -pg 1 -y 160 -defaultsOSRD
preplace inst rst_processing_system7_0_100M -pg 1 -lvl 1 -y 170 -defaultsOSRD
preplace inst Conways_write_4reg_0 -pg 1 -lvl 3 -y 230 -defaultsOSRD
preplace inst Top_0 -pg 1 -lvl 4 -y 200 -defaultsOSRD
...
preplace netloc Top_0_output_row 1 2 3 770 80 NJ 80 1440
preplace netloc Conways_write_4reg_0_write_single_pe 1 3 1 N
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 460
preplace netloc Conways_write_4reg_0_control_signal 1 3 1 N
preplace netloc Top_0_green 1 4 1 NJ
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 10 70 410
preplace netloc Top_0_running_cycles 1 2 3 780 90 NJ 90 1430
...
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 80 430 320 770
preplace netloc reset_1 1 0 4 NJ 270 NJ 70 NJ 70 NJ
preplace netloc Conways_write_4reg_0_rowcoor 1 3 1 N
levelinfo -pg 1 -10 220 620 940 1280 1470 -top -20 -bot 570
",
}

...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set control_signal_out [ create_bd_port -dir O -from 10 -to 0 control_signal_out ]
  set running_cycles [ create_bd_port -dir I running_cycles ]
  set single_write_out [ create_bd_port -dir O -from 10 -to 0 single_write_out ]

  # Create instance: conways_write_2_0, and set properties
  set conways_write_2_0 [ create_bd_cell -type ip -vlnv LAFAYETTE:user:conways_write_2:1.0 conways_write_2_0 ]
...
CONFIG.NUM_MI {2} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins conways_write_2_0/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins conways_write_2_0/S01_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net conways_write_2_0_control_signal [get_bd_ports control_signal_out] [get_bd_pins conways_write_2_0/control_signal]
  connect_bd_net -net conways_write_2_0_write_single_pe [get_bd_ports single_write_out] [get_bd_pins conways_write_2_0/write_single_pe]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins conways_write_2_0/s00_axi_aclk] [get_bd_pins conways_write_2_0/s01_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins conways_write_2_0/s00_axi_aresetn] [get_bd_pins conways_write_2_0/s01_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]
  connect_bd_net -net running_cycles_1 [get_bd_ports running_cycles] [get_bd_pins conways_write_2_0/output_cycles]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs conways_write_2_0/S00_AXI/S00_AXI_reg] SEG_conways_write_2_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs conways_write_2_0/S01_AXI/S01_AXI_reg] SEG_conways_write_2_0_S01_AXI_reg
...
preplace port running_cycles -pg 1 -lvl 3:-120 -defaultsOSRD -top
preplace portBus control_signal_out -pg 1 -y 340 -defaultsOSRD
preplace portBus single_write_out -pg 1 -y 320 -defaultsOSRD
preplace inst rst_processing_system7_0_100M -pg 1 -lvl 1 -y 320 -defaultsOSRD
preplace inst conways_write_2_0 -pg 1 -lvl 3 -y 330 -defaultsOSRD
preplace inst processing_system7_0_axi_periph -pg 1 -lvl 2 -y 280 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -y 520 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 1 3 NJ 440 NJ 440 NJ
preplace netloc processing_system7_0_axi_periph_M00_AXI 1 2 1 N
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 440
preplace netloc conways_write_2_0_write_single_pe 1 3 1 NJ
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 230 410
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 1 2 450 420 760
preplace netloc running_cycles_1 1 2 1 750
preplace netloc conways_write_2_0_control_signal 1 3 1 NJ
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ 460 NJ 460 NJ
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 1 1 420
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 220 430 430 750
preplace netloc processing_system7_0_axi_periph_M01_AXI 1 2 1 N
levelinfo -pg 1 0 220 600 910 1090 -top 0 -bot 650
",
}
